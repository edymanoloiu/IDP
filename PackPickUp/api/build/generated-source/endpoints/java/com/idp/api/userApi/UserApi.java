 ...
 * on 2015-05-09 at 11:25:02 UTC 
 * Modify at your own risk.
 */

package com.idp.api.userApi;
...
public class UserApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   *
   * @param content the {@link com.idp.api.userApi.model.User}
   * @return the request
   */
  public InsertUser insertUser(com.idp.api.userApi.model.User content) throws java.io.IOException {
    InsertUser result = new InsertUser(content);
    initialize(result);
    return result;
  }

  public class InsertUser extends UserApiRequest<com.idp.api.userApi.model.User> {
     ...
     * @since 1.13
     */
    protected InsertUser(com.idp.api.userApi.model.User content) {
      super(UserApi.this, "POST", REST_PATH, content, com.idp.api.userApi.model.User.class);
    }
  ...
  public class ListUsers extends UserApiRequest<com.idp.api.userApi.model.CollectionResponseUser> {
     ...
     */
    protected ListUsers() {
      super(UserApi.this, "GET", REST_PATH, null, com.idp.api.userApi.model.CollectionResponseUser.class);
    }
  ...
  public class RemoveUser extends UserApiRequest<Void> {
   ...
   * @return the request
   */
  public UpdateUser updateUser(com.idp.api.userApi.model.User content) throws java.io.IOException {
    UpdateUser result = new UpdateUser(content);
    initialize(result);
    return result;
  }

  public class UpdateUser extends UserApiRequest<com.idp.api.userApi.model.User> {
     ...
     * @since 1.13
     */
    protected UpdateUser(com.idp.api.userApi.model.User content) {
      super(UserApi.this, "PUT", REST_PATH, content, com.idp.api.userApi.model.User.class);
    }
